      ...
      <div className="block_offset">
        ...
        <div className="text text_column">
          ...
          <a 
            ...
            rel="noreferrer"
          >резюме</a>
          . Окончателният документ заедно с приложенията към него ще бъде публикуван след представянето му на <Link to='/conference'>Националната велосипедна конференция</Link> и приемането му от междуведомствената работна група. Можете да се регистрирате за участие на&nbsp;
