    ...
    <Fragment>
      ...
      <div className="block_offset">
        ...
        <div className="text text_column">
          ...
          маршрути. Конкретните трасета ще бъдат представени на <Link to='/conference'>Националната велосипедна конференция</Link>.
          <br />
          <br />
          Можете да разгледате трета глава на &nbsp;  
          <a 
            href='http://www.baatbg.org/uploads/docs/vision.NCP.Bulgaria.pdf'
            target='_blank' 
            rel="noreferrer"
          >
            Националния велосипеден план - Визия и планиране тук
          </a>. Целият документ ще бъде публикуван след приключване на всички текстове и представянето му на Националната велосипедна конфереция. Предварителен вариант на документа ще бъде изпратен по електронна поща до участниците, които са се регистрирали в конференцията. Можете да се регистрирате за участие на&nbsp;
          <Link to='/conference'>конференцията тук</Link>. 
        </div>
      </div>
      <div className="block_offset">
