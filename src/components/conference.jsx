    ...
    return (
      <div>
        ...
        <div className="form_container">
          ...
          <div className="text">
            <br />
            На 3 ноември 2022 в зала 10 на НДК от 09:00 ч. ще се проведе Национална велосипедна конференция, която ще събере заинтересовани страни в областта на развитие на велосипедното движение и велотуризма от цялата страна. 
             На
