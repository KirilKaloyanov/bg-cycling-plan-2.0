    ...
    return (
      <div>
        ...
        <div className="form_container">
          ...
          <div className="text">
            <br />
            На 3 ноември 2022 в зала 10 на НДК ще се проведе Национална велосипедна конференция, която ще събере заинтересовани страни в областта на развитие на велосипедното движение и велотуризма от цялата страна. 
             На
            конференцията ще бъдат представени <nbsp />
            ...
            target='_blank' 
            rel="noreferrer"
          >Предварителна програма</a> може да изтеглите тук. Организаторите си запазват правото на промени в програмата.
            <br />
            <br />
