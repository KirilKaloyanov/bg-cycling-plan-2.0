    ...
    return (
      <div>
        ...
        <div className="form_container">
          ...
          <div className="text">
            <br />
            На 3 ноември 2022 в зала 10 на НДК ще се проведе Национална велосипедна конференция,
            където ще бъде обсъден <nbsp />
            <Link to="/page">Националния велосипеден план</Link>. 
            Можете да разгледате трета глава на плана -&nbsp;  
            <a 
              href='http://www.baatbg.org/uploads/docs/vision.NCP.Bulgaria.pdf'
              target='_blank' 
              rel="noreferrer"
            >
              Визия и планиране тук
            </a>
            . Целият документ ще бъде публикуван след приключване на всички текстове и представянето му на Националната велосипедна конфереция. Предварителен вариант на документа ще бъде изпратен по електронна поща до участниците, които са се регистрирали в конференцията. На
            конференцията ще бъдат представени конкретните трасета на Национална
            мрежа от велосипедни маршрути. Можете да разгледате предварителната{" "}
            <Link to="/map">схема на основните направления тук</Link>.
            <br />
            <br />
            ...
            <ul>
              ...
              <li>Организиране на велосипедни пътувания за чужденци</li>
            ...
            информация относно програмата и лекторите на
            събитието. Регистрираните участници първи ще получат целия текст на Националния велосипеден план за да се запознаят с него преди провеждане на конференцията.
            <br />
            <br />
